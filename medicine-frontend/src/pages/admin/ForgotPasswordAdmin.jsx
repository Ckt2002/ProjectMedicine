...
function ForgotPasswordAdmin() {
    ...
    const handleCodeSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.get(`http://localhost:8080/api/account/confirm-email/${email}/${code}`);
            if (response.status === 200) {
                setStep(3);
            } else {
            ...
            setNotification({ message: 'Error verifying code', type: 'error' });
        }
    };
    ...
    const handlePasswordReset = async (e) => {
        ...
        try {
            ...
            await axios.put(`http://localhost:8080/api/account/updatePassword`, newAccount);
                        ...
                        <div className="card">
                            <div className="card-body">
                                <div className="app-brand justify-content-center">
                                    <Link to="/admin" className="app-brand-link gap-2">
                                ...
                                {step === 1 && (
                                    <div>
                                        ...
                                        <p className="mb-4">Enter your email and we'll send you codes to reset your password</p>
                                        <form id="formAuthentication" className="mb-3" onSubmit={handleEmailSubmit}>
                                            <div className="mb-3">
                                ...
                                {step === 2 && (
                                    <div>
                                        <h4 className="mb-2">Enter Verification Code</h4>
                                        <p className="mb-4">Check your email for the code</p>
                                        <form id="formAuthentication" className="mb-3" onSubmit={handleCodeSubmit}>
                                            <div className="mb-3">
                                ...
                                {step === 3 && (
                                    <div>
                                        ...
                                        <form id="formAuthentication" className="mb-3" onSubmit={handlePasswordReset}>
                                            <div className="mb-3">
